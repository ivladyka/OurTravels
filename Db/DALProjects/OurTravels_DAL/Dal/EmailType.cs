...
{
    public abstract class _EmailType : SqlClientEntity
    {
        public _EmailType()
        {
            this.QuerySource = "EmailType";
            this.MappingName = "EmailType";
        ...
        public bool LoadAll()
        {
            ...
            return base.LoadFromSql("[" + this.SchemaStoredProcedure + "LoadAllEmailType]", parameters);
        }
        ...
        //=================================================================
        public virtual bool LoadByPrimaryKey(int EmailTypeID)
        {
            ListDictionary parameters = new ListDictionary();
            parameters.Add(Parameters.EmailTypeID, EmailTypeID);


            return base.LoadFromSql("[" + this.SchemaStoredProcedure + "LoadEmailTypeByPrimaryKey]", parameters);
        }
        ...
        public class ColumnNames
        {
            ...
            static public string ToPropertyName(string columnName)
            {
                if (ht == null)
                {
                    ...
                    ht[EmailTypeID] = _EmailType.PropertyNames.EmailTypeID;
                    ht[Name] = _EmailType.PropertyNames.Name;
        ...
        public class PropertyNames
        {
            ...
            static public string ToColumnName(string propertyName)
            {
                if (ht == null)
                {
                    ...
                    ht[EmailTypeID] = _EmailType.ColumnNames.EmailTypeID;
                    ht[Name] = _EmailType.ColumnNames.Name;
        ...
        protected override IDbCommand GetInsertCommand()
        {
            ...
            cmd.CommandText = "[" + this.SchemaStoredProcedure + "InsertEmailType]";
        ...
        protected override IDbCommand GetUpdateCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "[" + this.SchemaStoredProcedure + "UpdateEmailType]";
        ...
        protected override IDbCommand GetDeleteCommand()
        {
            ...
            SqlCommand cmd = new SqlCommand();
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.CommandText = "[" + this.SchemaStoredProcedure + "DeleteEmailType]";
